    ...
    <div className="p-6 space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl">건강한 라이프스타일</h1>
            <p className="text-sm text-gray-600">운동만큼 중요한 생활 습관</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end p-3">
            <p className="text-white text-sm">마음의 평화</p>
          </div>
        </motion.div>
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end p-3">
            <p className="text-white text-sm">건강한 식단</p>
          </div>
        </motion.div>
      </div>
              ...
              >
                <Card className="p-5">
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`w-10 h-10 rounded-full bg-gradient-to-br ${category.color} flex items-center justify-center`}
                    >
              ...
              >
                <Card className="p-5">
                  ...
                  <ul className="space-y-2">
                    {category.tips.map((tip, idx) => (
                      <li key={idx} className="flex items-start gap-2 text-sm text-gray-700">
                        <span className="text-pink-600 flex-shrink-0 mt-1">✓</span>
                        <span>{tip}</span>
                      </li>
                    ))}
                  </ul>
      ...
      >
        <Card className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <h3 className="mb-4 text-center">이상적인 하루 루틴</h3>
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">7:00</span>
              <span>기상, 물 한 잔</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">7:30</span>
              <span>아침 식사 + 단백질</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">12:00</span>
              <span>점심 식사 + 가벼운 산책</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">17:00</span>
              <span>운동 30-60분</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">19:00</span>
              <span>저녁 식사</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">22:00</span>
              <span>스트레칭 + 명상</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-16 text-gray-600">23:00</span>
              <span>취침</span>
            </div>
          </div>
        </Card>
